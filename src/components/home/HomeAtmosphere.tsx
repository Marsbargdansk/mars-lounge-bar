...
export const HomeAtmosphere = ({data}: { data: HomePageData | null }) => {
    return (
        <BigCardWrapper>
            <div className="flex flex-col gap-4 sm:gap-0 sm:flex-row w-full px-0 sm:py-10 sm:px-12">
                <div className="w-full sm:w-1/2 flex-col my-auto py-4 px-4 sm:px-0 sm:mr-12">
                    <CardTitle title={data?.atmosphereTitle} className='m-0 sm:m-0 mb-5 '/>

                    <p className="text-[14px] leading-6 text-white/60 text-center">
